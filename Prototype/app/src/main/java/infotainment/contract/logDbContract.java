...
public final class logDbContract {
    ...
    public static class logEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_TITLE = "rpm";
        public static final String COLUMN_NAME_SUBTITLE = "speed";
    }

    public static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + logEntry.TABLE_NAME + " (" +
                    logEntry._ID + " INTEGER PRIMARY KEY," +
                    logEntry.COLUMN_NAME_TITLE + " TEXT," +
                    logEntry.COLUMN_NAME_SUBTITLE + " TEXT)";
